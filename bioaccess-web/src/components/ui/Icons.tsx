...
export function IconFingerprint({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M7.864 4.243A7.5 7.5 0 0119.5 10.5c0 2.92-.556 5.709-1.568 8.268M5.742 6.364A7.465 7.465 0 004.5 10.5a23.87 23.87 0 001.63 8.873M5.742 6.364L4.5 5.122m1.242 1.242l1.06 1.06M12 10.5v4.5m0 0l-1.5-1.5M12 15l1.5-1.5M9.878 9.878l-3-3m12.728 0l-3 3m-9.193 9.193A5.25 5.25 0 0012 18.75c1.232 0 2.365-.415 3.268-1.113" />
    </svg>
  );
}
